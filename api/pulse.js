/*
  API de la tabla de posiciones global de Color Pulse — usado por
  js/pulse.js en play/pulse.html. Mismo patrón que las otras (Redis
  sorted set), con sus propias claves.

  GET  /api/pulse?visitorId=v123        -> { top: [{name, score}, ...], you: {rank, score} | null }
  POST /api/pulse { name, score, visitorId } -> guarda el puntaje si es
       un nuevo mejor para ese visitorId, devuelve la misma forma que el GET.
*/

const { createClient } = require('redis');

const BOARD_KEY = 'pulse:board';
const NAMES_KEY = 'pulse:names';
const TOP_N = 10;
