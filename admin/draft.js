...
var SYSTEM_PROMPT = [
  ...
  '{"title": "...", "dek": "...", "body": "...", "category": "...", "readTime": "..."}',
].join('\n');

function draftArticle(item, cfg, categoryOptions) {
  cfg = cfg || loadConfig();
