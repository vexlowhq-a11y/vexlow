    ...
    <article class="article-page">
      ...
      <div class="games-grid">
        <a class="game-card" href="trivia.html">
          <img class="game-card-cover" src="../img/games/trivia-cover.jpg" alt="Daily Trivia" width="440" height="440" loading="lazy">
        ...
        <a class="game-card" href="dash.html">
          <img class="game-card-cover" src="../img/games/dash-cover.jpg" alt="Vex Dash" width="440" height="440" loading="lazy">
          <span class="game-card-desc">Tap to jump, dodge the spikes, beat your best score.</span>
        </a>
        <a class="game-card" href="snake.html">
          <img class="game-card-cover" src="../img/games/snake-cover.jpg" alt="Neon Snake Survival" width="440" height="440" loading="lazy">
          <span class="game-card-desc">Swipe to steer, eat the orbs, don't run into yourself.</span>
        </a>
        <a class="game-card" href="orbit.html">
          <img class="game-card-cover" src="../img/games/orbit-cover.jpg" alt="Neon Orbit" width="440" height="440" loading="lazy">
          <span class="game-card-desc">Tap to flip your orbit and dodge the blocks closing in.</span>
        </a>
        <a class="game-card" href="gravity.html">
          <img class="game-card-cover" src="../img/games/gravity-cover.jpg" alt="Gravity Flip" width="440" height="440" loading="lazy">
        ...
        <a class="game-card" href="pulse.html">
          <img class="game-card-cover" src="../img/games/pulse-cover.jpg" alt="Color Pulse" width="440" height="440" loading="lazy">
